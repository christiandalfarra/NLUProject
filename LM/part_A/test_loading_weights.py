...
results.append(testing_LSTM(400, 350, vocab_len, lang.word2id['<pad>'], 'bin/LSTM_embsize400_hidsize350_lr0.05.pt', train_loader, dev_loader, test_loader))
results.append(testing_LSTM(400, 350, vocab_len, lang.word2id['<pad>'], 'bin/LSTM_embsize400_hidsize350_lr0.1.pt', train_loader, dev_loader, test_loader))